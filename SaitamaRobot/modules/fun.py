...
__mod_name__ = "Fun"
__command_list__ = [
    "runs", "slap", "billy" , "roll", "fire", "water", "toss", "shrug", "bluetext", "rlg", "decide",
    "table", "pat", "sanitize", "shout", "weebify", "8ball"
]
__handlers__ = [
    RUNS_HANDLER, SLAP_HANDLER, BILLY_HANDLER, FIRE_HANDLER, WATER_HANDLER, PAT_HANDLER, ROLL_HANDLER, TOSS_HANDLER,
